        ...
        "Mathématiques": {
            "Équations": {
                "Racines": {
                    ...
                    "function_to_call": "def racines():\n\tdrawTxt(\"Résoudre l'équation ax^2+bx+c=0\", 0, "
                                        "0)\n\tdrawTxt(\"a\",0,30)\n\ta = 0\n\twhile a == 0:\n\t\ta = cinput("
                                        ")\n\tdrawRect(0, 70, 340, 20, (255, 255, 255))\n\tdrawTxt(\"b\",0,"
                                        "30)\n\tb = cinput()\n\tdrawRect(0, 70, 340, 20, (255, 255, 255))\n\tdrawTxt("
                                        "\"c\",0,30)\n\tc = cinput()\n\tdelta = b**2 - 4*a*c\n\tif delta > 0:\n\t\tx1 "
                                        "= -(-b**2 + math.sqrt(delta)) / (2*a)\n\t\tx2 = -(-b**2 - math.sqrt(delta)) "
                ...
                "Discriminant": {
                    ...
                    "function_to_call": "def discriminant():\n\tdrawTxt(\"Trouver le discriminant de l'équation "
                                        "ax^2+bx+c=0\", 0, 0)\n\tdrawTxt(\"a\",0,30)\n\ta = 0\n\twhile a == 0:\n\t\ta "
                                        "= cinput()\n\tdrawRect(0, 70, 340, 20, (255, 255, 255))\n\tdrawTxt(\"b\",0,"
                                        "30)\n\tb = cinput()\n\tdrawRect(0, 70, 340, 20, (255, 255, 255))\n\tdrawTxt("
                                        "\"c\",0,30)\n\tc = cinput()\n\tdelta = b**2 - 4*a*c\n\treturn \"Cette "
                                        "équation a pour discriminant : \" + delta"
                },
                "Retour": {}
